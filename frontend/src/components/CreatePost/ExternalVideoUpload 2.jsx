...
const ExternalVideoUpload = ({ isOpen, onVideoSelect, onClose }) => {
  ...
  return (
    <div className="external-video-upload" onClick={onClose}>
      <div className="external-video-modal" onClick={(e) => e.stopPropagation()}>
