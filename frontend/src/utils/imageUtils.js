...
export const getAvatarThumbnailUrl = (avatarPath) => {
  ...
  if (avatarPath.includes('drive.google.com')) {
    try {
      ...
      if (fileId) {
        // Возвращаем URL для thumbnail без кэш-бастера для производительности
